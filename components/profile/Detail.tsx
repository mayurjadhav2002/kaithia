...
const Detail = () => {
	return (
		<div className='px-6 mt-3 '>
				...
				<div className='flex justify-between items-center '>
					<div className='flex items-start gap-2'>
						...
						<div className='flex flex-col justify-between'>
							<p className='text-md font-semibold'>Add social links </p>
							<p className='text-xs'>
								{" "}
			...
			<div className='space-y-4'>
				...
				<div className='flex justify-between items-center '>
					<div className='flex items-start gap-2'>
						...
						<div className='flex flex-col justify-between'>
							<p className='text-md font-semibold'>Add Experience </p>
							<p className='text-xs'>
								{" "}
								<span className='text-green-600'>+20</span>{" "}
								Points
			...
			<div className='space-y-4'>
				...
				<Link href={"/"} className="text-violet-700 font-semibold text-sm">
				<svg xmlns="http://www.w3.org/2000/svg" className="bi bi-pencil-fill w-4 h-4" viewBox="0 0 16 16">
  <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
				...
				<div className='flex justify-start items-center gap-1 flex-wrap '>
					<p className="px-2 py-1.5 text-md font-medium border-[1px] rounded-lg">Javascript</p>
					<p className="px-2 py-1.5 text-md font-medium border-[1px] rounded-lg">Python</p>

					<p className="px-2 py-1.5 text-md font-medium border-[1px] rounded-lg">React</p>

					<p className="px-2 py-1.5 text-md font-medium border-[1px] rounded-lg">Node</p>
					<p className="px-2 py-1.5 text-md font-medium border-[1px] rounded-lg">RestAPI</p>
